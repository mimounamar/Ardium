...
public class OxiumBush extends Block
...
public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int par6, float par7, float par8, float par9)
{
  ...
  if (meta >= 1)
  {
    ...
    world.setBlock(x, y, z, this, 0, 3);
    world.spawnEntityInWorld(new EntityItem(world, player.posX, player.posY, player.posZ, new ItemStack(OxiumIngot.oxium)));
    return true;
  }
  return false;
}
...
{
  return Item.getItemFromBlock(Ardium.obush);
}
